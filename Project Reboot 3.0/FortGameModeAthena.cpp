...
bool AFortGameModeAthena::Athena_ReadyToStartMatchHook(AFortGameModeAthena* GameMode)
{
	...
	if (AmountOfRestarts != LastNum3)
	{
		...
		std::string serverup = "{\"content\":\"<@&1113589635239657482>\",\"embeds\":[{\"title\":\"Servers Up!\",\"description\":\"Ready Up!\",\"color\":null,\"author\":{\"name\":\"flow gameserver\",\"icon_url\":\"https://i.ibb.co/SJv9mk7/5c683727-1322-4171-9aee-55f193473bda.png\"},\"image\":{\"url\":\"https://i.ibb.co/pQ558Lr/960x0.webp\"}}],\"attachments\":[]}";
